                                    ...
                                    <a href="#">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2.5">
                                                ...
                                                <span class="item-text text-lg font-medium leading-none">Inicio</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2.5">
                                                ...
                                                <span
                                                    class="item-text text-lg font-medium leading-none">Productos</span>
                                            </div>
                                            <span>
                                            ...
                                            <div class="flex items-center space-x-2.5">
                                                <span class="item-ico">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <ellipse cx="11.7778" cy="17.5555" rx="7.77778"
                                                            ry="4.44444" class="path-1" fill="#1A202C" />
                                                        <circle class="path-2" cx="11.7778" cy="6.44444"
                                                            r="4.44444" fill="#22C55E" />
                                                    </svg>
                                                </span>
                                                <span
                                                    class="item-text text-lg font-medium leading-none">Usuarios</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
            ...
            <aside class="relative hidden w-[96px] bg-white dark:bg-black sm:block">
                <div class="sidebar-wrapper-collapse relative top-0 z-30 w-full">
                    <div
                        ...
                        <a href="index.html">
                            <img src="./assets/images/logo/logo-short.svg" class="block dark:hidden"
                                alt="logo" />
